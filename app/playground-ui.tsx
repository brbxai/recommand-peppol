    ...
    <div className="absolute top-0 left-0 right-0 mx-auto z-50 bg-data dark:text-darkslate w-fit h-fit py-1 px-2 rounded-b-sm">
      <div className="flex items-center justify-center gap-2">
        <p className="text-sm font-medium">
          This is a {playground.useTestNetwork ? "Peppol Test Network " : ""}
          ...
          <Tooltip>
            ...
            <TooltipContent variant="muted" className="max-w-sm">
              <p className="text-sm text-pretty">
                A playground is used to test the Recommand API without affecting
                production data or communicating over the Peppol network.{" "}
                {testNetworkText} You can switch to a production environment by
